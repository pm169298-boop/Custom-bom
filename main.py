...
def speed_kb(prefix: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [
            btn("ғᴀsᴛ", f"{prefix}:speed:fast", None, "🚀", style="danger"),
            btn("ᴍᴇᴅɪᴜᴍ", f"{prefix}:speed:medium", None, "⚡", style="primary"),
            btn("sʟᴏ", f"{prefix}:speed:slow", None, "🐢", style="success")
        ],
        [btn("ᴄᴀɴᴄᴇʟ", f"{prefix}:home", None, "❌", style="danger")]
    ])
...
def force_join_kb(missing: list) -> InlineKeyboardMarkup:
    ...
    rows.append([btn("🔄 ʀᴇғʀᴇsʜ / ᴄʜᴇᴄᴋ", "fj:check", None, "", style="primary")])
    return InlineKeyboardMarkup(inline_keyboard=rows)
...
def user_kb() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [btn("📹 ᴠɪᴅᴇᴏs", "user:random_video", None, "", style="primary"), btn("💳 ᴄʀᴇᴅɪᴛs", "user:credits", None, "", style="primary")],
        [btn("🎁 ʀᴇᴅᴇᴇᴍ", "user:redeem", None, "", style="primary"), btn("👥 ʀᴇғᴇʀ", "user:refer", None, "", style="primary")],
        [btn("📊 sᴛᴀᴛs", "user:stats", None, "", style="primary"), btn("📜 ᴍʏ sᴍs ʜɪsᴛᴏʀʏ", "user:sms_history", None, "", style="primary")],
        [btn("💰 ʙᴜʏ ᴄʀᴇᴅɪᴛs", "user:pricing", None, "", style="success")],
        [btn("💸 ᴛʀᴀɴsғᴇʀ ᴄʀᴇᴅɪᴛs", "user:transfer", None, "", style="primary")],
